...
public class Character : MonoBehaviour
{
    ...
    private Vector3 restartposition = new Vector2(0, 1);
    private Ray2D ray2D;
    ...
    internal void CharacterPause()//게임 일시정지
    {
        isgamepause = true;
    }

    internal void CharacterPlay()//게임 시작
    {
        isgamepause = false;
    }

    internal void CharacterRestart()
    {
    ...
    private void ItemRestart()
    {
        inventory.InventoryRestart();
    }
