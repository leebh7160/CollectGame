...
public class Inventory : MonoBehaviour
{
    ...
    internal void InventoryRestart()
    {
        InvenControl_RestartSlot();
    ...
    private void InvenControl_RestartSlot()//인벤토리 초기화
    {
        for (int i = 0; i < ItemSlot.childCount; i++)
        {
            if (ItemSlot.GetChild(i).childCount == 1)
                Destroy(ItemSlot.GetChild(i).GetChild(0).gameObject);
        }
    }
    #endregion
}
